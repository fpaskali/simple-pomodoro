...
def main():
    ...
    parser.add_argument("-pomodoro", type=int, help="Duration of working period", default=25)
    parser.add_argument("-short", type=int, help="Duration of short break", default=5)
    parser.add_argument("-long", type=int, help="Duration of long break", default=5)
    parser.add_argument("-repeats", type=int, help="Number of working periodes, before long break", default=4)
